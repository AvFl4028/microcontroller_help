...
export default function App() {
    ...
    return (
        <>
            <NavBar sendChildMessage={sendChildMessage} />
            <div className="container containerMain animation_in">
                <Card
                    title_one={dataJson.arduino.title}
                    text_one={dataJson.arduino.data}
                    img_one={ArduinoImg}
                    languaje_one={dataJson.arduino.programming_languaje}
                    title_two={dataJson.esp32.title}
                    text_two={dataJson.esp32.data}
                    img_two={Esp32Img}
                />
